...
import { useDeleteComment } from '@/hooks/api/review.hook';
...
export default function DeleteComment({ commentId }: Props) {
  ...
  const { mutate: deleteCommentMutate, isPending } = useDeleteComment();
    ...
    <Dialog open={open} onOpenChange={setOpen} modal={false}>
      ...
      <DialogContent className="z-50">
        <DialogHeader>
          ...
          <DialogDescription>Hành động này không thể hoàn tác. Đánh giá sẽ bị xóa vĩnh viễn.</DialogDescription>
        </DialogHeader>
