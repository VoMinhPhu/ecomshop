  ...
  return (
    <div>
      <div
        ...
        className={cn(
          'fixed bg-white size-13 z-10 border-2 shadow-sm flex items-center justify-center md:bottom-4 bottom-15 md:right-4 right-1 rounded-full cursor-pointer transition-all duration-100 ease-out',
